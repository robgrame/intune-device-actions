...
try {
    ...
    # Machine env override (capability-neutral INTUNE_ACTIONS_API_URL) wins
    # so the script detects a stale schedule.json when the Function App URL
    # has been repointed without re-installing the .intunewin package.
